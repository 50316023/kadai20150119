...
public class FrameSystemView extends Frame implements ActionListener,WindowListener{
	...
	private Button bm2 = new Button("M/M/S");
	...
	public void actionPerformed(ActionEvent e) {
		...
		text3.setText(String.valueOf(clib.getPlus()));
			...
			MM1_lib clib = new MM1_lib(lambda,mu);
			m3.setText(String.valueOf(clib.getLength()));
		}
			...
			MMS_lib clib = new MMS_lib(lambda,mu,s);
			m7.setText(String.valueOf(clib.getL()));
		}
	}
